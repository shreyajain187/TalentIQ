...
import type { CandidateAnalysis, CandidateViewModel, RankingWeights, JDParserOutput } from "@/lib/types";
import { getCandidateAnalyses, getJobDescription, getRequiredAndPreferredSkills, getJDInsights } from "@/lib/adapter";
import { defaultWeights, rankCandidates } from "@/lib/scoring";
import type { jdInsights as JDInsightsType } from "@/lib/mock/jd";
...
interface CandidatesContextValue {
  ...
  jdInsights: typeof JDInsightsType | null;
}
...
export function CandidatesProvider({ children }: { children: ReactNode }) {
  ...
  const [insights, setInsights] = useState<typeof JDInsightsType | null>(null);
